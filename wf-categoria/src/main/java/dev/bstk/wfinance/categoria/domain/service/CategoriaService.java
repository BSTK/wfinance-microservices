...
import dev.bstk.wfinance.categoria.domain.helper.DadosInvalidosException;
...
import static dev.bstk.wfinance.categoria.domain.helper.Mapper.map;
...
public class CategoriaService {
    ...
    public Categoria novaCategoria(final NovaCategoriaRequest request) {
        ...
        final var categoriaNova = map(request, Categoria.class);
